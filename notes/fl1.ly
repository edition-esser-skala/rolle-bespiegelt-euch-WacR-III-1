...
MundDerFlautoI = {
  \relative c' {
    ...
    e16. g32 fis8 d' d
    d cis16. h32 a8 g %5
    \pa \tuplet 3/2 8 { fis16[ e d] } d8 \pd r4
    \pa e32 fis g16 a, cis e g h g
    fis32 g a16 d,, fis a d fis d
    e32 fis g16 a, cis e g h g
    fis32 g a16 d,, fis a c e c \pd %10
    ...
    R2
    \pa cis32\fE d e16 a, cis e a cis a \pd
    h32[\p cis d16] e,8-! r4
    \pa cis32\fE d e16 a, cis e a cis a \pd %35
    ...
    d8 d32( cis) e( d) d4
    R2*3 %85
    \pa e32\f fis g16 a, cis e g h g
    fis32 g a16 d,, fis a d fis d
    e32 fis g16 a, cis e g h g
    fis32 g a16 d,, fis a c e c \pd
...
VerdamlicheBosheitFlautoI = {
  \relative c' {
    ...
    fis4 r r
    R2.*5 %29
    r16 \pa d,\fE d( g) g( h) h( d) \pd d( a) a( c) %30
    ...
    R2.*3 %51
    r16 h,\p h( e) \pa e( gis) gis( h) \pd a8-! r
    r16 h, h( e) \pa e( gis) gis( h) \pd a8-! r
    h,4 r r
    R2.*5 %59
    R2.\fermata %60
    R2.*3
    r16 \pa e,\p e( a) a( c) c( e) \pd e( h) h( d)
    \pa c e,\f e( a) a( c) c( e) \pd e( h) h( d) %65
...
RuhetSanftFlautoI = {
  \relative c' {
    ...
    a8.( h32 c) h4 r
    \pa d2 d8 fis,
    g \tuplet 3/2 8 { a16( h c) } \pd c4 h8.(\trill a32 h) %5
