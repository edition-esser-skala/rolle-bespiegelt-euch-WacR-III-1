...
BespiegeltEuchBassFigures = \figuremode {
  ...
  <6 5>2 \bo <[6]>8 \bc <[5]>
  <6 5>4 q2 %35
  \bo <[7 _+]>2. \bassFigureExtendersOn
  <7 _+>2.
  ...
  \bo <[9] 4>8 \bc <[8] 3> r2
  r4 <6> \bo <[7 _+]>
  <9 4>8 <8 3> r4 <6 4>8 \bc <[\t 3]>
  <7 _+>2.
  \bo <[6 4]>8 \bc <[5 _+]> r2 %50
  r4 <6> <_+>
  r \bo <[6]> \bc <[_+]>
  r <6>4. \bo <[5! \l]>8
  <7 _+>2.
  ...
  r4 <6> \bc <[6\\ 5]>
  <[5+] _+> <7> <6>
  \bo <[8 5+ _+]>8 <7 5+ _+> \bassFigureExtendersOn q2
  q2 q8 q \bassFigureExtendersOff
  <8 _+>8 <6+ 4 _!>2 \bassFigureExtendersOn <6+ 4 _!>8 %60
  q2 q8 \bc <[6+ 4 _!]> \bassFigureExtendersOff
  r4 <6!>2
  <7>4 <6>2
  <7>4 <6>2
  \bo <[7 \l]>4 <6> <8 6>8 <7 5> %65
  <6 4> \bc <[5 3]> r2
  <6 4>2.
  r8 \bo <[6 4 3]> \bassFigureExtendersOn <6 4 3>2
  q2.
  \bc <[6 4 3]>8 \bassFigureExtendersOff <6> <6 4> <4 2> <6> q %70
  q <[6]> <6 4>4 <5 3>
  r <[6]>2
  r4 <[6]>2
  r8 \bo <[6 \l]> <6 4> <2> <6> q
  ...
  <6>2 \bc <[6 \l]>4 %80
  r <6> q8 <[5]>
  <4> <_+>16 \bo <[1]> <1>16. q32 q16. q32 q16. q32 q16. q32
  <6>2 q4
  r q q8 <5>
  <4> <_+> r2 %85
  r4 <6> <_+>
  ...
  <[5+]> <6\\> <[6 _+]>
  <[6\\]> <6 4> <[5+] _+>
  \bo <[5 \l]>8. <1>16 q16. q32 q16. q32 q16. q32 q16. q32
  <6 _+>4 \bc <[5+ \l]> <6+ _+> %95
  r \bo <[6 5! _+]>2
  ...
  r4 <6>2
  r4 <6>2
  r8.. \bo <[6 \l]>32 <6 4>4 \bc <[5 3]> %124 finis
}
...
LassetUnsZuBassFigures = \figuremode {
  ...
  <\t \t>2 <7 5>4 <6 4>
  <\t \t> <5 3>2.
  <7 5>2 <6 4>4 \bc <[5 3]> %45
  r1
  r2 <6 4>
  \bo <[7- \l]>1 \bassFigureExtendersOn
  <7->1
  q %50
...
AlsErDahinKamBassFigures = \figuremode {
  ...
  \bo <[6 \l]>
  r2 <6 4->8 <5 3> r <6>
  <6>8 <6 4> <6-> <6 5-> <9 4-> <8 3>16. \bc <[6 \l]>32 r4
  r1 %5
  <6>4 <7->8 <6> <_->4 <7 _!>
  r2 <_!>
  r2 \bo <[6 4]>8 <5 _!>4.
...
WieQuaeletBassFigures = \figuremode {
  ...
  <6 4>4 <5 _+>2.
  r4 <6> \bc <[6 5 \l]>2
  \bo <[9] 4>4 \bc <[8] 3>2. %15
  <6>2 <7>4 <6>
  <6 4 2> <6> <[7] 4> <7>
  r2 <6 5!>
  \bo <[9 4]>8 <8 3> r4 <6 5>2
  <5 3>2 <6 4> %20
  <7 5>2.. <6 5>8
  r4. \bc <[6 4]>8 <7>2
  r <_->4 \bo <[5- \l]>8 \bc <[6- 4]>
  <7->4. <6- 4>8 <5->4 \bo <[7- \l]>
  <6! 4> \bc <[5 3]> r <6\\> %25
  r4 <7> <6>2
  \bo <[6 4]>4 <5 _+>2.
  r4 <6> <6 5>2
  ...
  <6 4> <5 _+> r2 <6 4>8 \bc <[5 _+]>
  r4 \bo <6\\ [5!]>8 \bc <\l [4]> r4. \bo <[7 _+]>8
...
LassMichAnAndernBassFigures = \figuremode {
  r2 \bo <[6 5]>
  <_!>4 <6>8 \bc <[6\\ \l]> <3>4 <_+>
  r1
  r4 <6 5> r4. <[6]>8
  <_+>1 %5
  <_+>
  r
  r4 \bo <[8 6]>8 <7 5> <5 3>2
  r4 <2> r <_+>
  r1 %10
  r2. <6>8 <6\\>
  r4 <6 5> r4. \bc <[6 \l]>8
...
UndUeberEineBassFigures = \figuremode {
  ...
  r16. <6 4>32 \bassFigureExtendersOn q8 q4 r16. q32 q8 q4 \bassFigureExtendersOff %50
  <5>8 <6-> q <5-> r4 \bc <[6 5]>
  r2 <2>
  <7 _!> <7 _!>
  <_->4 <6!> <_!>2
  <[6]>1 %55
  \bo <7 [5]>4 \bc <6 [4]>8 <[5 3]> r4. <6 4>8
  r4. \bo <[7 _!]>8 <6 4> <5! _+>4.
...
DieMaennerAberBassFigures = \figuremode {
  ...
  <[5 3]> <6 [4+] 2> %5
  r4 <_+>2.
  r2 \bo <[6]>8. <_+>16 \bc <[6]>4
  <6 4 2> <6\\>2.
  r8 <6 4> \bo <[7 \l]>4 <4+ 2> <6>8 <6 5>
  <7>4 <6\\> <_+>2 %10
  ...
  \bo <[_+]>1
  r4. <2>8 r4. \bc <[2]>8
  <6 5> \bo <[7 _+]> <7> \bc <[6 5]> r4. <6>8 %45
  <7 _+>4 <6\\>8 <6 4> <6 5> \bo <[7 _+]> <7> \bc <[6 5]>
  r1
  <6 _+>
  r2 <[5+] _+> %49 finis
}
...
WasDuerfenWirBassFigures = \figuremode {
  ...
  <4 2>4 <6 5> r \bo <[6 \l]>
  <_!>2 <6 _+>4 \bc <[_+ \l]>
  <_+>4. \bo <[4+ 2]>8 <6>4 \bc <[_+ \l]>
  <_+>4. \bo <[4+ 2]>8 <6>8 \bc <[5+ \l]> <5> <6> %15
  <6 4>4 <5 _+>8 <\t \t> <6>4 <_+>
  <7> <6> <_+>2
  <6 4> <5 _+>
  <6> \bo <[9]>4 \bc <[8]>
  <5> <7> <7 _+>4 \bo <[6 5]>8 \bc <[\t 4]> %20
  <6>2 \bo <[7 \l]>8 <6> <\t>4
  <4+ 2>4 <6>8 q <6 4>4 \bc <[5 _+]>
  r2.. %23 finis
}
...
ErHatDasVolckBassFigures = \figuremode {
  r8 r2 \bo <[6] 4>8 <5 3> r \bc <[6]>
  <7>4 <6> <[7]>4. <6>8
  <7>4 <6> \bo <[7 \l]>4. <6>8
  \bc <[6 5]>1
  r4 <6> \bo <[4 \l]> <_+> %5
  <9> <6> <9> <8>
  <7 _+>4 <6 4>4 <6 5> <6 4>8 \bc <[5 _+]>
  r2 <4>8 <_+> <7!>4
  <4>8 <3>4. \bo <[4 \l]>8 <3> <7!>4
  <4!>8 <3> <6> <6 5> <4> <3>4. %10
  <6 4>8 <5 3> <6 5!>4 <9 4!>8 <8 3> <6+ 5>4
  <9 4>8 <8 3> <6 5>4 <9 4>8 <8 3> <6 5>4
  <9 4>8 \bc <[8 3]>4. <7>2
  <6 5>2 \bo <[7 \l]>4. \bc <[6 5]>8
  \bo <[6] 4>4 \bc <[7!] 3> r4. %15 finis
}
...
EsSollDerOrgano = {
  \relative c {
    ...
    \partial 4 r4 \clef alto \tiny g'\pE^\vla b d
    g d4. g8
    es c fis4 d
    g, d' r8. g16
...
EsSollDerBOrgano = {
  \relative c {
    ...
    \partial 4 r4 \clef alto \tiny c'\pE^\vla es g
    c g r8 c
    as f h4 g
    c, g' r8. c16
...
EsWurdenAberBassFigures = \figuremode {
  ...
  \bo <[5 \t \l]>2 <5+ _!>
  <6+ _+> <5 \t>
  <7 5+ _+>4. <6+ \t \t>8 \bc <[5+ _! \l]>2 %18 finis
}
...
VerdamlicheBosheitBassFigures = \figuremode {
  r8 r4. <7 [_+]>8 \bo <[6 4]> \bc <[5 _+]>4.
  r4. <7 [_+]>8 \bo <[6 4]> \bc <[5 _+]>4.
  <7! _+>4 \bo <[6 5]> \bc <[9 4]>8 <6 4> <6 5> \bo <[7 \l]>
  <9 4> <6 4> r <6> q4. \bc <[6 \l]>8
  <_+>2 \bo <[5 _+]>8 <8 6> <7 5> <6 4> %5
  <5 _+>2 <5 _+>8 <8 6> <7 5> <6 4>
  <5 _+>1
  r4. <7 _+>8 <6 4> <5 _+>4.
  r4. <7 _+>8 <6 4> <5 _+>4.
  \bc <[7! _+]>4 <6 5> \bo <[9 4]>8 <6 4> <6 5> <7> %10
  <9 4> <6 4> r <6> q4. q8
  <_+>2 q
  r16 q4.. \bc <[_+ \l]>2
  r1
  ...
  <[_+]>1
  <7! _+>4 <6 4> <5 _+>
  r \bo <[8 6] _->8 \bc <[7 5] \t> \bo <[6] 4> \bc <[5] _+> %45
  r2 <_+>4
  r2 <_+>4
  \bo <[9 4]>8 \bc <[8 3]> r4 <6>
  <7 [5+ _+]> <_+> <6 5!>
  r <6 _!> <[7 _+]> %50
  <5 _+>2 <6 4>4
  <5 _+>2 <6 4>4
...
DerDuHerrOrgano = {
  \relative c {
    \clef bass
    \key d \major \time 4/4 \tempoDerDuHerr
    r4 d a' h
    fis h a! d,
    g2.\fermata fis4
    e d h' a
...
DerDuHerrBassFigures = \figuremode {
  r1
  <_+>
  r2. <6>4
  q2 <6>4 q
